...
@NonReusable
@Layout(R.layout.food_item_in_compare)
public class FoodItemInCompare {
    ...
    public FoodItemInCompare(Context context, PlaceHolderView phView, FoodItem foodItem){
    ...
    private void RemoveItemFromCart() {
        Variables.compareItems.remove(mFoodItem);
